    ...
    <div class="container">
      <div class="row">
        <div class="col-md-9 col-md-push-3">
          ...
          <?php $sql = "SELECT tblvehicles.*,tblbrands.BrandName,tbllocation.LocationName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand join tbllocation on tbllocation.id=tblvehicles.location";
          $query = $dbh->prepare($sql);
          $query->execute();
          $results = $query->fetchAll(PDO::FETCH_OBJ);
          $cnt = 1;
