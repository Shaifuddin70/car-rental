        ...
        <div class="col-md-9 col-md-push-3">
          <div class="result-sorting-wrapper">
            <div class="sorting-count">
              ...
              $sql = "SELECT id from tblvehicles where VehiclesBrand=:brand and FuelType=:fueltype and location=:location";
              $query = $dbh->prepare($sql);
              $query->bindParam(':brand', $brand, PDO::PARAM_INT);
              $query->bindParam(':fueltype', $fueltype, PDO::PARAM_STR);
              $query->bindParam(':location', $location, PDO::PARAM_INT);
              $query->execute();
        ...
        <aside class="col-md-3 col-md-pull-9">
          <div class="sidebar_widget">
            ...
            <div class="sidebar_filter">
              <form action="search-carresult.php" method="post"> <!-- Changed method to "post" -->
                <div class="form-group select">
                  <select class="form-control" name="location"> <!-- Corrected the name attribute -->
                ...
                <div class="form-group select">
                  <select class="form-control" name="brand"> <!-- Corrected the name attribute -->
                ...
                <div class="form-group select">
                  <select class="form-control" name="fueltype"> <!-- Corrected the name attribute -->
