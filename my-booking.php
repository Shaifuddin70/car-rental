                          ...
                          foreach ($results as $result) {  ?>
                            ...
                            <li>
                              ...
                              <?php if ($result->Status == 1) { ?>
                                <div class="vehicle_return">
                                  <?php $bookid = $result->id; ?>
                                  <a href="pay.php?bookingid=<?php echo $bookid; ?>" class="btn btn-xs uppercase">Return</a>
                                </div>
                            ...
                            <table>
                              ...
                              <tr>
                                ...
                                <td> <?php echo htmlentities($total = $result->PricePerDay * $result->totaldays); ?></td>
                                <td> <?php echo htmlentities($result->advance); ?></td>
                                <td> <?php echo htmlentities($result->due); ?></td>
                                <?php $_SESSION['newpay'] = $result->due + $result->advance; ?>
                              </tr>
                              <tr>
                                <th colspan="7" style="text-align:center;"> Grand Total</th>
                                <th><?php echo htmlentities($result->due); ?></th>
                              </tr>
                              <tr>
                                <th colspan="8" style="text-align:center;">Your Review: <?php echo  $result->review; ?>
                                </th>
                              </tr>
